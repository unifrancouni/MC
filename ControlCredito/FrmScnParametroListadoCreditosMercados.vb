    ...
    Private Sub cmdAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAceptar.Click
        ...
        Try
            ...
            If Me.NomRep = EnumReportes.ConsecutivoRecibosArqueo Then
                ...
                ElseIf Me.RdUsura.Checked = True Then 'If Me.RdUsura.Checked = True Then 'A partir de: 01/Marzo/2010
                    Filtro = Filtro & " And {vwSteListadoRecibosArqueadosAnuladosRep.nCodigoTalonario} = 1"
                ElseIf Me.RdBfp.Checked = True Then 'A partir de: 01/Febrero/2011
                    Filtro = Filtro & " And {vwSteListadoRecibosArqueadosAnuladosRep.nCodigoTalonario} = 2"
                Else 'If Me.RdUsuraCero.Checked=true Then 'A partir del 22/09/2014
                    Filtro = Filtro & " And {vwSteListadoRecibosArqueadosAnuladosRep.nCodigoTalonario} = 3"
                End If
            ...
            ElseIf Me.NomRep = EnumReportes.ConsecutivoRecibos Then
                ...
                Else 'If Me.RdUsuraCero.Checked=true Then 'A partir del 22/09/2014
                    Filtro = Filtro & " And {vwSteListadoConsecutivoRecibosRep.nCodigoTalonario} = 3"
                End If
                '5. Recibos Manuales:
            ...
            ElseIf Me.NomRep = EnumReportes.ListadoConsecutivoRecibosRango Then
                ...
                Else 'If Me.RdUsuraCero.Checked=true Then 'A partir del 22/09/2014
                    Filtro = Filtro & " And {vwSteListadoConsecutivoRecibosRangoRep.nCodigoTalonario} = 3"
                End If
            ...
            ElseIf Me.NomRep = EnumReportes.ListadoConsecutivoRecibosRangoTE Then
                ...
                Else 'If Me.RdUsuraCero.Checked=true Then 'A partir del 22/09/2014
                    Filtro = Filtro & " And {vwSteConsecutivoRecibosRangoTesoreriaRep.nCodigoTalonario} = 3"
                End If
            ...
            ElseIf Me.NomRep = EnumReportes.ConsolidadoRecibosCredito Then
                ...
                Else
                    ...
                    ElseIf Me.RdBfp.Checked = True Then  'A partir de: 01/Marzo/2010
                        frmVisor.Parametros("@nCodigoTalonario") = 2
                    ElseIf Me.RdUsuraCero.Checked = True Then
