        ...
        Try
            ...
            Select Case mNomRep
                Case EnumReportes.ComportamientoDeMora
                    ...
                    frmVisor.Parametros("@TipoPrograma") = IIf(Me.RdUsuraCero.Checked, 1, IIf(Me.RdVentanadeGenero.Checked, 2, 3))
                ...
                Case EnumReportes.Detalle
                    ...
                    frmVisor.Formulas("TipoPrograma") = "'" & IIf(Me.RdUsuraCero.Checked, 1, IIf(Me.RdVentanadeGenero.Checked, 2, 3)) & "'"
                    CadSql = ""
...
IIf(Me.RdMercado.Checked = True, " Mercado.nStbMercadoID AS IdAgrupacion, Mercado.sCodigo AS CodAgrupacion, Mercado.sNombre AS NomAgrupacion,  ", " vwUbicacion.nStbDistritoID As IdAgrupacion , vwUbicacion.CodDistrito As CodAgrupacion ,  vwUbicacion.Distrito As NomAgrupacion, ") & _
                    ...
                    Select Case TipoReporte
                        ...
                        Case 5
                            ...
                            frmVisor.SQLQuery = CadSql & Trim(Filtro) & " And vwSccDetalleCreditosProgramaFichaNotificacion.CodigoPrograma='" & IIf(Me.RdUsuraCero.Checked, 1, IIf(Me.RdVentanadeGenero.Checked, 2, 3)) & "'  And (SclGrupoSocia_1.nCoordinador = 1) AND (DFNC.nCreditoRechazado = 0) AND (EstadoFNC.sCodigoInterno = '2') And (dbo.vwSccListadoEstadoFichaNotificacionCredito.FichaActiva = 1)   "
