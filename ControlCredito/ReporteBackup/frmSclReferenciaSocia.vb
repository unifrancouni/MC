...
Public Class frmSclReferenciaSocia
    ...
    Private Sub CargarReferenciaSocia(ByVal sCadenaFiltro As String)
        Try
            ...
            Strsql = " SELECT nSclSociaID, nCodigo, NombreSocia, sNumeroCedula, sTelefonoSocia, sDireccionSocia, nStbDelegacionProgramaID " & _
                     " From vwSclSociasConReferencias " & sCadenaFiltro & _
            ...
            Strsql = " SELECT nSclReferenciaSociaID, nSclSociaID, NombreSocia, nActiva, CodReferencia, TipoReferencia, dFechaCreacion, AsignadaPor, sObservaciones " & _
                     " FROM vwSclReferenciasSocias " & sCadenaFiltro & _
    ...
    Private Sub LlamaAnularReferencia()
        ...
        Try
            ...
            Strsql = " Update SclReferenciaSocia " & _
                     " SET nUsuarioModificacionID = '" & InfoSistema.IDCuenta & "', dfechamodificacion = getdate(), sMotivoInactivacion = '" & strCausaAnulacion & "', nActiva = 0 " & _
    ...
    Private Sub toolAgregarR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles toolAgregarR.Click

    End Sub

    Private Sub toolImprimirS_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles toolImprimirS.Click
