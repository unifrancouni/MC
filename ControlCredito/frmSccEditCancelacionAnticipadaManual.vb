...
Public Class frmSccEditCancelacionAnticipadaManual
    ...
    Private Sub InicializarVariables()
        ...
        Try
            ...
            If ModoFrm = "ADD" Then
                Me.Text = "Agregar Recibo Oficial de Caja (Cancelación Anticipada Recibo Manual)"
            ...
            Else
                Me.Text = "Modificar Recibo Oficial de Caja (Cancelación Anticipada Recibo Manual)"
            End If
        ...
        Try
            ...
            Else
                If ModoFrm = "ADD" Then
                    ...
                    Call GuardarAuditoria(1, 23, "Cancelación Anticipada Manual Recibo ID: " & intReciboTmpID & ".")
