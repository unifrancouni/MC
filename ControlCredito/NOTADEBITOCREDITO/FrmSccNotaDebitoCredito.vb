Public Class FrmSccNotaDebitoCredito
    ...
    Private Sub FormatoSolicitudCheque()
        Try
            ...
            Me.grdNotas.Columns("nCodigo").Caption = "Nota No."
    ...
    Private Sub LlamaAutorizar()
        ...
        Try
            ...
            Strsql = " Update SccNotaCreditoDebito " & _
                     " SET nUsuarioModificacionID = '" & InfoSistema.IDCuenta & "', dfechamodificacion = getdate(), nStbEstadoNotaID = (SELECT a.nStbValorCatalogoID FROM StbValorCatalogo a INNER JOIN StbCatalogo b ON a.nStbCatalogoID = b.nStbCatalogoID WHERE a.sCodigoInterno = '3' And b.sNombre = 'EstadoNotaDebitoCredito')" & _
    ...
    Private Sub LlamaRevisar()
        ...
        Try
            ...
            ''Anula la Nota Actual:
            Strsql = " Update SccNotaCreditoDebito " & _
                     " SET nUsuarioModificacionID = '" & InfoSistema.IDCuenta & "', dfechamodificacion = getdate(), nStbEstadoNotaID = (SELECT a.nStbValorCatalogoID FROM StbValorCatalogo a INNER JOIN StbCatalogo b ON a.nStbCatalogoID = b.nStbCatalogoID WHERE a.sCodigoInterno = '2' And b.sNombre = 'EstadoNotaDebitoCredito')" & _
                     " WHERE nSccNotaID = " & XdsSolicitudCheque("Solicitud").ValueField("nSccNotaID")
            XcComando.ExecuteNonQuery(Strsql)
    ...
    Private Sub grdSolicitud_Filter(ByVal sender As Object, ByVal e As C1.Win.C1TrueDBGrid.FilterEventArgs) Handles grdDetalleFichas.Filter
        Try
            ...
            Me.grdDetalleFichas.Caption = " Listado de Solicitudes de Cheque (" + Me.grdDetalleFichas.RowCount.ToString + " registros)"
