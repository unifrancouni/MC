...
salir:
            ...
            Select Case mNomRep
                ...
                Case EnumReportes.Grupo, EnumReportes.GrupoRecupera, EnumReportes.GrupoCorte, EnumReportes.GrupoCorteVencidos, EnumReportes.ReporteDeMoraTotalizadoPorBarrios
                    ...
                    If mNomRep = EnumReportes.GrupoRecupera Then
                        ...
                        'frmVisor.Parametros("@TipoPrograma") = IIf(RdUsuraCero.Checked, 1, 2)
    ...
    Private Sub radTodosFecha_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles radTodosFecha.CheckedChanged
