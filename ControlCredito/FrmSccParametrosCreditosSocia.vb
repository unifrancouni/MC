...
salir:
            ...
            Select Case mNomRep
                ...
                Case EnumReportes.NumeroDesembolsos
                    ...
                    Select Case Me.CboVeces.SelectedIndex
                        ...
                        Case 11
                            frmVisor.Formulas("Parametro") = "'Incluido Socias con Once o más Créditos " & IIf(RdMercado.Checked, "En los Mercados", IIf(Me.RdDistrito.Checked, "En los Distritos", "")) & "'"
                            'Case 4
                    ...
                    frmVisor.Formulas("Parametros") = "' Parámetros (Depto.: " & Me.CboDepartamento.Text & ")  (Munic.: " & Me.cboMunicipio.Text & ") (Distrito:" & Me.cboDistrito.Text & ") (Barrio: " & Me.cboBarrio.Text & ") (Monto C$: " & Me.cboMontoAprobado.Text & ")'"
    ...
    "Extended Properties='Excel 12.0 Xml;HDR=Yes'")
       ...
       "IN ''[ODBC;Driver={SQL Server};" &
            ...
            Try
                ...
                MsgBox("Nº de registros exportados: " & CStr(n), vbInformation)
    ...
    Private Sub FrmSccParametrosCreditosSocia_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        If mNomRep = EnumReportes.NumeroDesembolsos Then
            ...
            'Deshabilitado, solicitud de Beyra (Alega que doña Leonor lo necesitaba urgente para ya ya ya) el 09/10/2017, no hay formato de cambio
