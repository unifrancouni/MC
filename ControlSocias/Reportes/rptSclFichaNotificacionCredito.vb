...
' Project Item Name:    rptSclFichaNotificacionCredito.vb
...
Public Class rptSclFichaNotificacionCredito
    ...
    Public Sub CargarFichaNotificacion()
        ...
        Try
            ...
            Strsql = " Select row_number() OVER (ORDER BY nCoordinador DESC, nSclFichaSociaId) AS Item, " & _
                     ...
                     " LugarEntregaCK, sHorarioEntregaPagos, DiaPagos, sObservacion, nMontoCreditoAprobado, nPlazoAprobado, TipoPlazo, sCodigoInterno, LugarPagos, nSclFichaSociaId, CodigoFuente " & _
    ...
    Private Sub rptSclFichaNotificacionCredito_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportStart
        Try
            ...
            If xdtFormato.ValueField("CodigoFuente") = "" Then
                StrSesion = xdtFormato.ValueField("sNumSesion")
            Else
                StrSesion = xdtFormato.ValueField("CodigoFuente") + "-" + xdtFormato.ValueField("sNumSesion")
            End If
            ...
            If RegistrosAsociados(strSQL) Then
                ...
                lblEncabezado.Text = "Por medio de la presente me permito informar que el Comité de Crédito del " & _
                                     "Programa Usura Cero, en sesión No. " & StrSesion & " efectuada el " & _
                ...
                If RegistrosAsociados(strSQL) Then 'Mercados Pago Diario
                    If StrEstado = "APROBO" Then
                        lblPie.Text = "En caso de aprobado, favor presentarse el día " & xdtFormato.ValueField("FechaEntregaCK") & ", a las " & xdtFormato.ValueField("HoraEntregaCK") & ", en el " & xdtFormato.ValueField("LugarEntregaCK") & " con " &
                                      "todas las integrantes del Grupo Solidario para el retiro del efectivo, firma del pagaré correspondiente y segunda capacitación " &
                                      "(TODAS DEBERAN TRAER CEDULA DE IDENTIDAD). No olvide retirar su Calendario de Pagos. " &
                                      "Las cuotas deberán ser canceladas en " & xdtFormato.ValueField("LugarPagos") & " " & xdtFormato.ValueField("sHorarioEntregaPagos") & " de lunes a viernes de cada semana."
                    Else
                    ...
                    End If
                Else 'Creditos Ordinarios Usura Cero
                    If StrEstado = "APROBO" Then
                        lblPie.Text = "En caso de aprobado, favor presentarse el día " & xdtFormato.ValueField("FechaEntregaCK") & ", a las " & xdtFormato.ValueField("HoraEntregaCK") & ", en el " & xdtFormato.ValueField("LugarEntregaCK") & " con " &
                                      "todas las integrantes del Grupo Solidario para el retiro de los cheques, firma del pagaré correspondiente y segunda capacitación " &
                                      "(TODAS DEBERAN TRAER CEDULA DE IDENTIDAD). No olvide retirar su Calendario de Pagos. " &
                                      "Las cuotas deberán ser canceladas en " & xdtFormato.ValueField("LugarPagos") & " " & xdtFormato.ValueField("sHorarioEntregaPagos") & " los días " & xdtFormato.ValueField("DiaPagos") & " de cada semana."
                    Else
                        lblPie.Text = "En caso de aprobado, favor presentarse el día        , a las         , en el          con todas las integrantes del " & _
            ...
            Else
                ...
                'Text Encabezado: 
                lblEncabezado.Text = "Por medio de la presente me permito informar que el Comité de Crédito del " & _
                                     "Fondo de Crédito Local (FCL-ME), en sesión No. " & StrSesion & " efectuada el " & _
                                     Format(xdtFormato.ValueField("dFechaNotificacion"), "dd' del mes de 'MMMM' del año 'yyyy") & _
                                     " " & StrEstado & " el Crédito solicitado por su Grupo Solidario a continuación detallado:"
                ...
                If StrEstado = "APROBO" Then
                    lblPie.Text = "En caso de aprobado, favor presentarse el día " & xdtFormato.ValueField("FechaEntregaCK") & ", a las " & xdtFormato.ValueField("HoraEntregaCK") & ", en el " & xdtFormato.ValueField("LugarEntregaCK") & " con " &
                                  "todas las integrantes del Grupo Solidario para el retiro de los cheques y firma del pagaré correspondiente " &
                                  "(TODAS DEBERAN TRAER CEDULA DE IDENTIDAD). No olvide retirar su Calendario de Pagos. " &
                                  "Las cuotas deberán ser canceladas en " & xdtFormato.ValueField("LugarPagos") & " " & xdtFormato.ValueField("sHorarioEntregaPagos") & " los días " & Microsoft.VisualBasic.DateAndTime.Day(xdtFormato.ValueField("FechaEntregaCK")) & " de cada mes."
                Else
                    lblPie.Text = "En caso de aprobado, favor presentarse el día        , a las         , en el          con todas las integrantes del " & _
            ...
            '------------------------
            lblNumero.Text = "PDIBA " & xdtFormato.ValueField("nCodigo")
