...
Public Class frmSclEditGarantiaFiduciaria
    ...
    Private Sub CargarGarantiaFiduciaria()
        ...
        Try
            ...
            If ObjFiadorDT.Count > 0 Then
                ...
                'If Not ObjGarantiaFiduciariadr.IsFieldNull("sCelular") Then
                '    Me.txtCelular.Text = ObjFiadorDT.ValueField("sCelular")
                'End If

                'If Not ObjGarantiaFiduciariadr.IsFieldNull("sTelefono") Then
                '    Me.txtTelefono.Text = ObjFiadorDT.ValueField("sTelefono")
                'End If

                'If Not ObjGarantiaFiduciariadr.IsFieldNull("sDireccion") Then
    ...
    Private Sub SalvarGarantiaFiduciaria()
        Try
			...
			If ModoFrm <> "ADD" Then
				GuardarAuditoriaTablas(13, 2, "Modificar Garantia Fiduciaria", intGarantiaFiduciariaID, InfoSistema.IDCuenta)
			End If
            ...
            If ModoFrm = "ADD" Then
                ...
                GuardarAuditoriaTablas(13, 1, "Agregar Garantia Fiduciaria", intGarantiaFiduciariaID, InfoSistema.IDCuenta)
            Else
