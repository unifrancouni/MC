...
Public Class frmSclEditCedula
    ...
    Private Function ValidaDatosEntrada() As Boolean
        ...
        Try
            ...
            If Me.IdTipoRecibo = 1 Then  'Automático
                If Trim(cadWhere) = "" Then
                    cadWhere = " Where nStbPersonaLugarPagosID=" & Me.IdPersonaLugarPagosID & "  And nStbTipoProgramaID= " & Me.nStbTipoProgramaID & " And  nStbTipoPlazoPagosID= " & Me.nStbTipoPlazoPagosID
                Else
                    '***ORIGINAL****
                    cadWhere = cadWhere & " And nStbPersonaLugarPagosID=" & Me.IdPersonaLugarPagosID & "  And nStbTipoProgramaID= " & Me.nStbTipoProgramaID & " And  nStbTipoPlazoPagosID= " & Me.nStbTipoPlazoPagosID
            ...
            '***ojo para que eimprima un regsitro con la cedula especifica****
            ...
            Else
                If ChkTipoBusqueda.Checked Then
                    ...
                    If XdtDatos.Count = 0 Then
                        ...
                        Exit Function
                    Else
                        If XdtDatos.ValueField("nStbPersonaLugarPagosID") = Me.IdPersonaLugarPagosID Then
