    ...
    Public Sub CargarFichaComite()
        ...
        Try
            ...
            Strsql = " Select row_number() OVER (ORDER BY nCoordinador DESC, nSclFichaSociaID) AS Item, " & _
                     ...
                     "        MontoTotalA, " & _
                     "        sCodigoInterno, " & _
                     "        nSclFichaSociaID, nTasaInteresAnual, nTasaMoraAnual, nTasaMantValorAnual " & _
                     " From vwSclFichaComiteCreditoRep " & _
                     ...
                     " sNumSesion, dFechaNotificacion, sObservacion, nMontoCreditoSolicitado, nPlazoSolicitado, " & _
                     " nMontoCreditoAprobado, nPlazoAprobado, TipoPlazo, PrimerFirma, SegundaFirma, TercerFirma, TituloF1, TituloF2, TituloF3, CargoF1, CargoF2, CargoF3, " & _
                     " sCodigoInterno, MontoTotalS, MontoTotalA, sCodigoInterno, nSclFichaSociaID, nTasaInteresAnual, nTasaMoraAnual, nTasaMantValorAnual " & _
