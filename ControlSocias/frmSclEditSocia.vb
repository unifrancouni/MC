...
Public Class frmSclEditSocia
    ...
    Private Sub InhabilitarControles()
        Try
            ...
            If ObjSociadr.nSociaActiva = 0 Then
                ...
                Me.grpEscolaridad.Enabled = False
    ...
    Private Function ValidaDatosEntrada() As Boolean
        ...
        Try
            ...
            Else
                ...
                If "0|1".Contains(Mid(Trim(RTrim(Me.mtbNumCedula.Text)), 9, 1)) Then
                    StrFecha = Mid(Trim(RTrim(Me.mtbNumCedula.Text)), 5, 2) + "/" + Mid(Trim(RTrim(Me.mtbNumCedula.Text)), 7, 2) + "/20" + Mid(Trim(RTrim(Me.mtbNumCedula.Text)), 9, 2)
            ...
            If Me.cboUniversidad.SelectedIndex = -1 Then
                MsgBox("Debe seleccionar un nivel de educación Universitario.", MsgBoxStyle.Critical, NombreSistema)
                ValidaDatosEntrada = False
                Me.errSocia.SetError(Me.cboSecundaria, "Debe seleccionar un nivel de escolaridad Universitario.")
                Me.cboSecundaria.Focus()
                Exit Function
            End If
            ...
            If (CInt(cboUniversidad.Columns("sCodigoInterno").Value) > 1) And (cboSecundaria.Columns("sCodigoInterno").Value <> "6") Then
                ...
                ValidaDatosEntrada = False
                Me.errSocia.SetError(Me.cboSecundaria, "Imposible indicar Educación Universitaria si no se tiene la Secundaria aprobada.")
                Me.cboSecundaria.Focus()
                Exit Function
            End If
    ...
    Private Sub CargarUniversidad()
        Try
            ...
            If XdsEscolaridad.ExistTable("Universidad") Then
                XdsEscolaridad("Universidad").ExecuteSql(Strsql)
            Else
                XdsEscolaridad.NewTable(Strsql, "Universidad")
                XdsEscolaridad("Universidad").Retrieve()
            End If

            'Asignando a las fuentes de datos
            Me.cboUniversidad.DataSource = XdsEscolaridad("Universidad").Source
            ...
            'Ubicarlo en el primer registro:
            If Me.cboUniversidad.ListCount > 0 Then
                Me.cboUniversidad.SelectedIndex = 0
            End If
    ...
    Private Sub CargarUniversidadSocia()
        Dim strSQL As String
        strSQL = "select * from vwStbUniversidadSocia where nSclSociaID=" & IdSocia

        If XdsEscolaridad.ExistTable("UniversidadSocia") Then
            XdsEscolaridad("UniversidadSocia").ExecuteSql(strSQL)
        Else
            XdsEscolaridad.NewTable(strSQL, "UniversidadSocia")
            XdsEscolaridad("UniversidadSocia").Retrieve()
        End If

        If IsDBNull(XdsEscolaridad("UniversidadSocia").ValueField("nSclSociaID")) Or XdsEscolaridad("UniversidadSocia").ValueField("nSclSociaID") Is Nothing Then
            cboUniversidad.SelectedIndex = 0
        Else
            cboUniversidad.SelectedValue = CInt(XdsEscolaridad("UniversidadSocia").ValueField("nStbValorCatalogoID"))
        End If

    End Sub

    Private Sub SalvarUniversidadSocia()
        Dim XcDatos As New BOSistema.Win.XComando
        Dim strSQL2 As String
        strSQL2 = "spSclGrabarUniversidadSocia " & IdSocia & ", " & cboUniversidad.SelectedValue & ", " & InfoSistema.IDCuenta
    ...
    Private Sub chkFormarGS_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkFormarGS.CheckedChanged
        vbModifico = True
    End Sub

    'Para controlar la ubicación del foco en el checkbox Formar GS
    Private Sub chkFormarGS_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles chkFormarGS.GotFocus
        Try
    ...
    Private Sub chkFormarGS_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles chkFormarGS.LostFocus
        Try
    ...
    Private Sub mtbNumHijos_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles mtbNumHijos.TextChanged
        vbModifico = True
    End Sub

    Private Sub mtbHijosDep_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles mtbHijosDep.TextChanged
        vbModifico = True
    End Sub
    ...
    Private Sub cboOtroDocumento_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboOtroDocumento.TextChanged
        vbModifico = True
    End Sub

    Private Sub txtOtroDocumento_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtOtroDocumento.TextChanged
        vbModifico = True
    End Sub
