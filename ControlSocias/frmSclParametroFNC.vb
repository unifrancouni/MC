...
Public Class frmSclParametroFNC
    ...
    ' Descripción:          Muestra o imprimi directo a impresora el reporte luego salvar los mismos en la Base de Datos.
    '-----------------------------------------------------------------------------------------------------------------------
    Public Sub RptFichaNotificacionCredito(ByVal nSclFichaNotificacionID As Int32, ByVal Copias As Integer, ByVal intervalo As Boolean, ByVal simpresora As String, Optional ByVal toprint As Boolean = False)
        ...
        Dim strSQL As String, sqlStr As String
        'Si es Grupo Solidario Usura / Mercados:

        If EnumReportes.rptSclFichaNotificacionCredito Then
            strSQL = "SELECT SclFichaNotificacionCredito.nSclFichaNotificacionID " & _
                 ...
                 "WHERE SclFichaNotificacionCredito.nSclFichaNotificacionID = " & nSclFichaNotificacionID & ""
            If RegistrosAsociados(strSQL) Then
                ...
                Select Case idTipoPrograma
                    Case 1
                        ObjReporte = CargarRepFichaNotificacionCredito_FCL()

                    Case 2
                        ObjReporte = CargarRepFichaNotificacionCredito_Ventana()
                        ' Return
                    Case 3
                        ObjReporte = CargarRepFichaNotificacionCredito_FCL()
                        'Return
                ...
                End Select
                'ObjReporte = CargarRepFichaNotificacionCredito_FCL() 'Usura Cero PDIBA
            End If
        Else
            strSQL = "SELECT SclFichaNotificacionCredito.nSclFichaNotificacionID " & _
                 "FROM  SclGrupoSolidario INNER JOIN SclTipodePlandeNegocio ON SclGrupoSolidario.nSclTipodePlandeNegocioID = SclTipodePlandeNegocio.nSclTipodePlandeNegocioID INNER JOIN SclFichaNotificacionCredito ON SclGrupoSolidario.nSclGrupoSolidarioID = SclFichaNotificacionCredito.nSclGrupoSolidarioID " & _
                 "INNER JOIN StbValorCatalogo ON SclTipodePlandeNegocio.nStbTipoProgramaID = StbValorCatalogo.nStbValorCatalogoID " & _
                 "WHERE (StbValorCatalogo.sCodigoInterno = '1') AND (SclFichaNotificacionCredito.nSclFichaNotificacionID = " & nSclFichaNotificacionID & ")"
    ...
    Public Sub RptCancelacionYVigencia(ByVal codigoFicha As String, ByVal ReporteDeCancelacionCredito As Boolean, ByVal simpresora As String, ByVal copias As Integer, ByVal intercalar As Boolean, Optional ByVal toprint As Boolean = False)
        ...
        sqlStr = "SELECT CAT.sCodigoInterno " & _
                 ...
                 "SclTipodePlandeNegocio AS TPN ON GS.nSclTipodePlandeNegocioID = TPN.nSclTipodePlandeNegocioID INNER JOIN " & _
                 "SclFichaNotificacionCredito AS FNC ON GS.nSclGrupoSolidarioID = FNC.nSclGrupoSolidarioID INNER JOIN " & _
                 "StbValorCatalogo AS CAT ON TPN.nStbTipoProgramaID = CAT.nStbValorCatalogoID WHERE  FNC.nSclFichaNotificacionID = " & codigoFicha & ""
        idTipoPrograma = Data.ExecuteScalar(sqlStr)

        If idTipoPrograma = 3 Then
            frmVisor.NombreReporte = IIf(ReporteDeCancelacionCredito, "RepSccCC82_PDIBA.rpt", "RepSccCC83_PDIBA.rpt")
        Else
    ...
    Private Sub frmSclParametroFNC_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If mNomRep = EnumReportes.rptSccSolicitudCheque Or mNomRep = EnumReportes.rptSclReporteDeCancelacionCredito Or mNomRep = EnumReportes.rptSclReporteDeVigenciaCredito Then
    ...
    Private Function CargarRepFichaComiteCredito() As DataDynamics.ActiveReports.ActiveReport3
        ...
        Try
            ...
            sqlStr = "SELECT CAT.sCodigoInterno " & _
                     ...
                     "SclTipodePlandeNegocio AS TPN ON GS.nSclTipodePlandeNegocioID = TPN.nSclTipodePlandeNegocioID INNER JOIN " & _
                     "SclFichaNotificacionCredito AS FNC ON GS.nSclGrupoSolidarioID = FNC.nSclGrupoSolidarioID INNER JOIN " & _
                     "StbValorCatalogo AS CAT ON TPN.nStbTipoProgramaID = CAT.nStbValorCatalogoID WHERE FNC.nSclFichaNotificacionID = " & Me.intFormatoID & ""
            idTipoPrograma = Data.ExecuteScalar(sqlStr)
            ObjRptSclFichaComite.TipoPrograma = idTipoPrograma
    ...
    Private Function CargarRepSolicitudDesembolso() As DataDynamics.ActiveReports.ActiveReport3
        ...
        Try
            ...
            sqlStr = "SELECT CAT.sCodigoInterno " & _
                     ...
                     "StbValorCatalogo AS CAT ON TPN.nStbTipoProgramaID = CAT.nStbValorCatalogoID WHERE FNC.nSclFichaNotificacionID = " & Me.intFormatoID & ""
            idTipoPrograma = Data.ExecuteScalar(sqlStr)
            ObjRptSclSolicitudDesembolso.TipoPrograma = idTipoPrograma
    ...
    Private Function CargarRepSolicitudCheque() As DataDynamics.ActiveReports.ActiveReport3
        ...
        Try
            ...
            sqlStr = "SELECT CAT.sCodigoInterno " & _
                     ...
                     "StbValorCatalogo AS CAT ON TPN.nStbTipoProgramaID = CAT.nStbValorCatalogoID WHERE FNC.nSclFichaNotificacionID = " & Me.intFormatoID & ""
            idTipoPrograma = Data.ExecuteScalar(sqlStr)
            ObjRptSccSolicitudCheque.TipoPrograma = idTipoPrograma
    ...
    Private Function CargarRepFichaNotificacionCredito_FCL() As DataDynamics.ActiveReports.ActiveReport3
        ...
        Try
            ...
            ObjRptSclFichaNotificacion.NombreGrupo = Me.StrNombre 'Código y Nombre del GS
            ObjRptSclFichaNotificacion.Estado = Me.StrCodEstado
            ObjRptSclFichaNotificacion.TipoPrograma = idTipoPrograma
            Return ObjRptSclFichaNotificacion
    ...
    Private Function CargarRepFichaNotificacionCredito_Ventana() As DataDynamics.ActiveReports.ActiveReport3
        'Declaracion de Variables
        Dim ObjRptSclFichaNotificacion As rptSclFichaNotificacionCredito_Ventana
        Try

            ObjRptSclFichaNotificacion = New rptSclFichaNotificacionCredito_Ventana
            ObjRptSclFichaNotificacion.IdFicha = Me.intFormatoID
            ObjRptSclFichaNotificacion.CodigoFicha = Me.StrCodigo
            ObjRptSclFichaNotificacion.NombreGrupo = Me.StrNombre 'Código y Nombre del GS
            ObjRptSclFichaNotificacion.Estado = Me.StrCodEstado
