Public Class frmSclEditReferenciaComercial
    ...
    Dim intSclReferenciaComercialID As Integer
    ...
    Public Property intReferenciaComercialID() As Integer
        Get
            intReferenciaComercialID = intSclReferenciaComercialID
        End Get
        Set(ByVal value As Integer)
            intSclReferenciaComercialID = value
        End Set
    End Property
        ...
        Try
            If ModoFrm = "ADD" Then
                If intTipoPersona = 1 Then
                    Me.Text = "Agregar Referencia Comercial al Credito"
                Else
                    Me.Text = "Agregar Referencia Comercial al Fiador"
                End If

            Else
                If intTipoPersona = 1 Then
                    Me.Text = "Modificar Referencia Comercial al Credito"
                Else
                    Me.Text = "Modificar Referencia Comercial al Fiador"
                End If
            End If
    ...
    Private Sub CargarDatos()
        ...
        Try
            ...
            If intTipoPersona = 1 Then 'Credito
                strSQL = "SELECT     nSclReferenciaComercialID, nSclFichaSociaID, nStbComercioID,  dFechaReferencia, nStbPersonaReferenciaID, nAnionRelacion, sUsuarioCreacion, dFechaCreacion, sUsuarioModificacion, dFechaModificacion FROM         dbo.SclReferenciaComercial Where nSclReferenciaComercialID=" & Me.intReferenciaComercialID

            Else ' Fiador


                strSQL = "SELECT     nSclReferenciaComercialFiadorID, nSclGarantiaFiduciariaID, nStbComercioID,  dFechaReferencia, nStbPersonaReferenciaID, nAnionRelacion, sUsuarioCreacion, dFechaCreacion, sUsuarioModificacion, dFechaModificacion FROM         dbo.SclReferenciaComercialFiador Where nSclReferenciaComercialFiadorID=" & Me.intReferenciaComercialID
            ...
            'Banco
            If Not IsDBNull(RegTmp.ValueField("nStbComercioID")) Then

                CargarInstitucion(RegTmp.ValueField("nStbComercioID"))
                If Me.cboInstitucion.ListCount > 0 Then
                    Me.cboInstitucion.SelectedIndex = 0
                End If

                XdsFicha("Institucion").SetCurrentByID("nStbPersonaID", RegTmp.ValueField("nStbComercioID"))
                'Me.cboFiador.Enabled = False
            Else
    ...
    Private Function ValidaDatosEntrada() As Boolean
        Try
            ...
            If Me.cboInstitucion.SelectedIndex = -1 Then
                MsgBox("Debe seleccionar un Comercio válido.", MsgBoxStyle.Critical, "SMUSURA0")
    ...
    Private Sub SalvarReferencia()
        ...
        Try
            ...
            StrSql = "Exec spSclGrabarReferenciaComercial'" & ModoFrm.ToString() & "'," & Me.intSclTipoPersona & "," & Me.intFichaID & "," & intSclReferenciaComercialID & "," & intReferenciaCrediticiaID & "," & XdsFicha("Fiador").ValueField("nStbPersonaID") & "," & XdsFicha("Institucion").ValueField("nStbPersonaID") & ",'" & Format(Me.cdeFechaReferencia.Value, "yyyy-MM-dd") & "'," & Me.cneAnioRelacion.Value & ",'" & InfoSistema.LoginName & "'"
            ...
            Else
                If ModoFrm = "ADD" Then
                    ...
                    intSclReferenciaComercialID = xResponse
                Else
