    ...
    Private Sub SalvarSocia()
        ...
        Try
            ...
            Else
                ...
                nSclConyugeID = ObjSociadr.nSclConyugeID
            End If
            ...
            Dim IdSocia As Integer

            StrQuery = "SELECT MAX(nSclConyugeID) as Cant FROM SclSociaConyuge"
            XdtConsulta = New BOSistema.Win.XDataSet.xDataTable
            XdtConsulta.ExecuteSql(StrQuery)

            If XdtConsulta.Count > 0 Then
                IdSocia = XdtConsulta.ValueField("Cant")
            End If

            If ModoFrm <> "ADD" Then
                GuardarAuditoriaTablas(17, 2, "Modificar Socia Cónyuge", nSclConyugeID, InfoSistema.IDCuenta)
            End If
            ...
            If ModoFrm = "ADD" Then
                ...
                nSclConyugeID = ObjSociadr.nSclConyugeID
                GuardarAuditoriaTablas(17, 1, "Agregar Socia Cónyuge", nSclConyugeID, InfoSistema.IDCuenta)
