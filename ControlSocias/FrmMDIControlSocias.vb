...
Public Class FrmMDIControlSocias
    ...
    Private Sub Seguridad()
        Try
            ...
            'Opcion Supervisiones
            If Seg.HasPermission("Supervisiones") Then
                Me.mnuSupervision.Enabled = True
            Else
                Me.mnuSupervision.Enabled = False
            End If
            ...
            'Opción Seguimiento a Visitas (Acompañamiento)
            If Seg.HasPermission("MantVisitasSocias") Then
                Me.mnuVisitas.Enabled = True
            Else
                Me.mnuVisitas.Enabled = False
            End If

            'Opción Mantenimiento a Promoción
            If Seg.HasPermission("MantPromocion") Then
                Me.mnuPromocion.Enabled = True
            Else
                Me.mnuPromocion.Enabled = False
            End If
            ...
            If Seg.HasPermission("mnuMetaProsperidad") Then
                Me.mnuMetaProsperidad.Enabled = True
            Else
                Me.mnuMetaProsperidad.Enabled = False
            End If
            'Opción Imprimir CS61
            If Seg.HasPermission("mnuSociasDenegadasUbicacion") Then
                Me.mnuRepCS61.Enabled = True
            Else
                Me.mnuRepCS61.Enabled = False
            End If
            ...
            If Seg.HasPermission("ImprimirReporteCS59") = False Then
                Me.mnuReporteCS59.Enabled = False
            Else  'Habilita
                Me.mnuReporteCS59.Enabled = True
            End If


            If Seg.HasPermission("ImprimirReporteCS60") = False Then
                Me.mnuReporteCS60.Enabled = False
            Else  'Habilita
                Me.mnuReporteCS60.Enabled = True
            End If

            'ImprimirReportesPresidencia
            If Seg.HasPermission("ImprimirReportesPresidencia") = False Then
                Me.mnuReporteCS62.Enabled = False
                Me.mnuReporteCS63.Enabled = False
                Me.mnuReporteCS64.Enabled = False
            Else  'Habilita
                Me.mnuReporteCS62.Enabled = True
                Me.mnuReporteCS63.Enabled = True
                Me.mnuReporteCS64.Enabled = True
            End If
    ...
    Private Sub mnuReporteCS58_Click(ByVal sender As System.Object, ByVal e As C1.Win.C1Command.ClickEventArgs)
        Dim ObjFrmSccParametrosCreditosSocia As New frmSclParametrosReportesSociaUbicacion
        Try
            If My.Application.OpenForms.Count > 2 Then
                Exit Sub
    ...
    Private Sub mnuMetaProsperidad_Click(ByVal sender As System.Object, ByVal e As C1.Win.C1Command.ClickEventArgs) Handles mnuMetaProsperidad.Click
        Try
            LlamarMetaProsperidad()
        Catch ex As Exception
            Control_Error(ex)
        End Try
    End Sub

    Private Sub LlamarMetaProsperidad()

        Dim ObjFrmSclMetaProsperidadCreditoSocia As frmSclMetaProsperidadCreditoSocia

        Try
            ObjFrmSclMetaProsperidadCreditoSocia = New frmSclMetaProsperidadCreditoSocia

            '-- Poner el cursor en un estado de ocupado
            Me.Cursor = System.Windows.Forms.Cursors.WaitCursor
            ObjFrmSclMetaProsperidadCreditoSocia.MdiParent = Me

            ObjFrmSclMetaProsperidadCreditoSocia.WindowState = FormWindowState.Maximized
            OpenForm(ObjFrmSclMetaProsperidadCreditoSocia, Me)

            '-- Para enviar el foco al formulario 
            '-- que se está llamando.
            ObjFrmSclMetaProsperidadCreditoSocia.BringToFront()
        ...
        Catch ex As Exception
            Control_Error(ex)
        Finally
            ObjFrmSclMetaProsperidadCreditoSocia = Nothing
        End Try

    End Sub

    Private Sub mnuReporteCS59_Click(ByVal sender As System.Object, ByVal e As C1.Win.C1Command.ClickEventArgs) Handles mnuReporteCS59.Click
        LlamImprimirGruposMorosos(7)
    End Sub

    Private Sub mnuReporteCS60_Click(ByVal sender As System.Object, ByVal e As C1.Win.C1Command.ClickEventArgs) Handles mnuReporteCS60.Click
        LlamImprimirGruposMorosos(8)
    End Sub

    Private Sub LlamImprimirGruposMorosos(ByVal IdReporte As Integer)
        Dim ObjFrmSclParametroGrupoPago As New frmSclParametroGrupoPago
        Try
            If My.Application.OpenForms.Count > 2 Then
                'MsgBox("En Construcción", MsgBoxStyle.Information, NombreSistema)
    ...
    Private Sub mnuRepCS61_Click(ByVal sender As System.Object, ByVal e As C1.Win.C1Command.ClickEventArgs) Handles mnuRepCS61.Click
    ...
    Private Sub mnuReporteCS58_Click_1(ByVal sender As System.Object, ByVal e As C1.Win.C1Command.ClickEventArgs) Handles mnuReporteCS58.Click
        Dim ObjFrmSccParametrosCreditosSocia As New frmSclParametrosReportesSociaUbicacion
        Try
            If My.Application.OpenForms.Count > 2 Then
                Exit Sub
    ...
    Private Sub mnuReporteCS62_Click(sender As System.Object, e As C1.Win.C1Command.ClickEventArgs) Handles mnuReporteCS62.Click
        Dim ObjFrmSccParametrosCreditosSocia As New frmSclParametrosReportesSociaUbicacion
        Try
            If My.Application.OpenForms.Count > 2 Then
                Exit Sub
            ...
            ObjFrmSccParametrosCreditosSocia.NomRep = 14
            ObjFrmSccParametrosCreditosSocia.strColor = "RojoLight"
            ObjFrmSccParametrosCreditosSocia.ShowDialog()
    ...
    Private Sub mnuReporteCS63_Click(sender As System.Object, e As C1.Win.C1Command.ClickEventArgs) Handles mnuReporteCS63.Click
        Dim ObjFrmSccParametrosCreditosSocia As New frmSclParametrosReportesSociaUbicacion
        Try
            If My.Application.OpenForms.Count > 2 Then
                Exit Sub
            ...
            ObjFrmSccParametrosCreditosSocia.NomRep = 15
            ObjFrmSccParametrosCreditosSocia.strColor = "RojoLight"
            ObjFrmSccParametrosCreditosSocia.ShowDialog()
    ...
    Private Sub mnuReporteCS64_Click(sender As System.Object, e As C1.Win.C1Command.ClickEventArgs) Handles mnuReporteCS64.Click
        Dim ObjFrmSccParametrosCreditosSocia As New frmSclParametrosReportesSociaUbicacion
        Try
            If My.Application.OpenForms.Count > 2 Then
                Exit Sub
            ...
            ObjFrmSccParametrosCreditosSocia.NomRep = 16
            ObjFrmSccParametrosCreditosSocia.strColor = "RojoLight"
            ObjFrmSccParametrosCreditosSocia.ShowDialog()
    ...
    Private Sub mnuSupervision_Click(sender As Object, e As C1.Win.C1Command.ClickEventArgs) Handles mnuSupervision.Click
        Dim ObjFrmSclReferenciaSocia As New frmSclSupervision
        ...
        Finally
            ...
            ObjFrmSclReferenciaSocia = Nothing
        End Try
    End Sub

    Private Sub mnuVisitas_Click(sender As Object, e As C1.Win.C1Command.ClickEventArgs) Handles mnuVisitas.Click
        Dim obj As New frmSclSeguimientoVisitas
        Try
    ...
    Private Sub mnuPromocion_Click(sender As Object, e As C1.Win.C1Command.ClickEventArgs)
        Dim obj As New frmSclSeguimientoVisitas
        Try
    ...
    Private Sub mnuPromocion_Click_1(sender As Object, e As C1.Win.C1Command.ClickEventArgs) Handles mnuPromocion.Click
        Dim obj As New frmSclPromocion
        Try
    ...
    Private Sub cmdFichasKiosco_Click(sender As Object, e As C1.Win.C1Command.ClickEventArgs) Handles cmdFichasKiosco.Click
        Dim obj As New frmSclParametrosFichasKioscos
    ...
    Private Sub cmdResumenAtencionK1_Click(sender As Object, e As C1.Win.C1Command.ClickEventArgs) Handles cmdResumenAtencionK1.Click
        Dim obj As New frmSclParametrosFichasKioscos
