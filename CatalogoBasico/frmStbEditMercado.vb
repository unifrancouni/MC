...
Public Class frmStbEditMercado
        ...
        Try
            If TipoObjeto = eTipoObjeto.Mercado Then
                ...
                Else  'ADD
                    ...
                    SQlQuery += IIf(ModoFrm = "ADD", "'", " sCodigo = '") & "" & IIf(ModoForm = "ADD", Me.GeneraCodigo(3, 0), Me.txtCodigo.Text) + "', "
                    ...
                    SQlQuery += IIf(ModoFrm = "ADD", "", " nCooperativa = ") & "0"
                    ...
                    '    Else
                    XdsComando.ExecuteScalar(SQlQuery)
                    'End If
    ...
    Public Function GeneraCodigo(ByVal MaxLength As Integer, ByVal Cooperativa As Int16) As String
        Dim XdDatos As New BOSistema.Win.XComando
        Dim strQuery As String
