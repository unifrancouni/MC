Public Class FrmSsgEditCuenta
    ...
    Private Sub CargarEmpleados()
        Try
            ...
            Strsql = " Select NombreEmpleado, sNumCedula,       nSrhEmpleadoID, " & _
                     "        nActivo,         dFechaIngreso, dFechaEgreso " & _
                     " From   VwSsgEmpleadosNaturales " & _
                     " Where  dFechaEgreso Is Null " & _
