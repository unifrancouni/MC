...
salir:
        ...
        Try
            ...
            If Me.NomRep = EnumReportes.ListadoRecibosArqueoCajero Then
                ...
                If optDetalle.Checked = True Then
                    If chkCaja.Checked = True And cboCaja.Text <> "" Then
                        ...
                        If Me.cboCajero.Columns("nSrhEmpleadoID").Value <> -19 Then
                            If OptSistema.Checked = True Then
                                Filtro = Filtro & "{vwSccArqueoRecibosCajasResumenGrupo.nSrhEmpleadoCajeroID}=" & Me.cboCajero.Columns("nSrhEmpleadoID").Value
                            Else
                                Filtro = Filtro & "{vwSccArqueoRecibosCajasResumenManuales.nSrhEmpleadoCajeroID}=" & Me.cboCajero.Columns("nSrhEmpleadoID").Value
                            End If
                        ...
                        If Trim(Filtro2) <> "" Then
                            ...
                            Else
                                Filtro = Filtro & " And {vwSccArqueoRecibosCajasResumenManuales.dFechaRecibo} <= #" & Format(CdeFechaFinal.Value, "yyyy-MM-dd") & "#"
                            End If
                        ...
                        Else
                            ...
                            Else
                                Filtro = " {vwSccArqueoRecibosCajasResumenManuales.dFechaRecibo} <= #" & Format(CdeFechaFinal.Value, "yyyy-MM-dd") & "#"
                            End If
                        ...
                        If Trim(Filtro2) <> "" Then
                            ...
                            Else
                                Filtro = Filtro & " And {vwSccArqueoRecibosCajasResumenManuales.dFechaRecibo} >= #" & Format(cdeFechaInicial.Value, "yyyy-MM-dd") & "#"
                            End If
                        ...
                        Else
                            ...
                            Else
                                Filtro = " {vwSccArqueoRecibosCajasResumenManuales.dFechaRecibo} >= #" & Format(cdeFechaInicial.Value, "yyyy-MM-dd") & "#"
                            End If
                    ...
                    ElseIf chkCaja.Checked = False And cboCaja.Text = "" Then
                        ...
                        If Me.cboCajero.Columns("nSrhEmpleadoID").Value <> -19 Then
                            ...
                            Else
                                Filtro = "{vwSccArqueoRecibosCajasResumenManuales.nSrhEmpleadoCajeroID}=" & Me.cboCajero.Columns("nSrhEmpleadoID").Value
                            End If
            ...
            If mNomRep = EnumReportes.ListadoRecibosArqueoCajero Then
                ...
                If optDetalle.Checked = True Then
                    ...
                    If chkCaja.Checked = False And cboCaja.Text = "" And OptSistema.Checked = True Then
                        frmVisor.Text = "Monto Por Grupos ingresado por Cajero y Fecha"
                        If Filtro2 <> "" Then
                    ...
                    If chkCaja.Checked = False And cboCaja.Text = "" And OptManual.Checked = True Then
                        frmVisor.Text = "Monto De Recibos Manuales ingresado por Cajero y Fecha"
                        If Filtro2 <> "" Then
                            frmVisor.SQLQuery = "SELECT * FROM vwSccArqueoRecibosCajasResumenManuales WHERE " & Filtro2
                        Else
                            frmVisor.SQLQuery = "SELECT * FROM vwSccArqueoRecibosCajasResumenManuales"
                        End If
                        frmVisor.NombreReporte = "RepSccCC44C.rpt"
                    End If
                Else
                    ...
                    Else
                        If cboCaja.Text = "Todas" And cboCajero.Text = "Todos" Then
                            frmVisor.SQLQuery = "SELECT * FROM vwSccArqueoRecibosCajasResumenCajaManuales_Consolidado WHERE " & Filtro2
                        ElseIf cboCaja.Text <> "Todas" And cboCajero.Text = "Todos" Then
                            frmVisor.SQLQuery = "SELECT * FROM vwSccArqueoRecibosCajasResumenCajaManuales_Consolidado WHERE " & Filtro2 & " AND nCodigo=" & Me.cboCaja.Columns("nCodigo").Value
                        End If
                        frmVisor.NombreReporte = "RepSccCC44D.rpt"
                    End If
    ...
    Private Sub optDetalle_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles optDetalle.CheckedChanged
        If Me.NomRep = EnumReportes.ListadoRecibosArqueoCajero And chkCaja.Checked = True Then
            grpManualSitema.Visible = False
        End If
    End Sub
