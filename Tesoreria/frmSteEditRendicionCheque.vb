Public Class frmSteEditRendicionCheque
    ...
    Private Sub InicializarVariables()
        Try
            If ModoForm = "ADD" Then
                Me.Text = "Agregar Solicitud de Rendición de Cheque"
            Else
                Me.Text = "Modificar Solicitud de Rendición de Cheque"
            End If
    ...
    Private Function ValidaDatosEntrada() As Boolean
        ...
        Try
            ...
            If FechaSuperiorAFechaDeseembolsoProveedor(Me.cdeFechaEmision.Value) = False Then
                MsgBox("La Fecha de Emisión  NO DEBE ser menor" & Chr(13) & "que la fecha de Desembolso Proveedor.", MsgBoxStyle.Critical, NombreSistema)
                ValidaDatosEntrada = False
