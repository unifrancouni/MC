        ...
        Try
            ...
            If intCajeroID = 0 Then
                ...
                If IntPermiteEditar = 0 Then
                    ...
                    Strsql = " Select a.nSrhEmpleadoID,a.nCodigo,a.sNombreEmpleado " & _
                             " From vwSclRepresentantePrograma a " & _
                             " WHERE (a.nActivo = 1) And ((a.sCodCargo = '04') OR (a.sCodCargo = '15')) AND (a.nStbDelegacionProgramaID = " & InfoSistema.IDDelegacion & ") " & _
                             " Order by a.nCodigo "
                ...
                Else
                    ...
                    Strsql = " Select a.nSrhEmpleadoID,a.nCodigo,a.sNombreEmpleado " & _
                             " From vwSclRepresentantePrograma a " & _
                             " WHERE (a.nActivo = 1) And ((a.sCodCargo = '04') OR (a.sCodCargo = '15')) " & _
                             " Order by a.nCodigo "
