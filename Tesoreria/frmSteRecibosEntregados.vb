    ...
    Private Sub LlamaRevertirCierre()
        ...
        Try
            ...
            If RegistrosAsociados(Strsql) Then
                ...
                Strsql = "Reversión de Cierre de Entrega de Recibos Códigos: " & XdsRecibo("Recibo").ValueField("nCodigoDesde") & " - " & XdsRecibo("Recibo").ValueField("nCodigoHasta") & ". Departamento: " & Me.cboDepartamento.Text & ". Cajero: " & XdsRecibo("Recibo").ValueField("Cajero") & "."
