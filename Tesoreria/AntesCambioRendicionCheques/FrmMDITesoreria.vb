...
Public Class FrmMDITesoreria
    ...
    Private Sub mnuAgregarChequeProveedor_Click(ByVal sender As System.Object, ByVal e As C1.Win.C1Command.ClickEventArgs) Handles mnuAgregarChequeProveedor.Click
