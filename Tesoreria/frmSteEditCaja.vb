...
Public Class frmSteEditCaja
    ...
    Private Sub SalvarCaja()
        ...
        Try
            ...
            If ModoFrm <> "ADD" Then
                GuardarAuditoriaTablas(10, 2, "Modificar SteCaja " & IIf(ModoFrm = "INN", "Inactivar Caja", ""), IdSteCaja, InfoSistema.IDCuenta)
            End If
            ...
            If ModoFrm = "ADD" Then
                GuardarAuditoriaTablas(10, 1, "Agregar SteCaja", IdSteCaja, InfoSistema.IDCuenta)
