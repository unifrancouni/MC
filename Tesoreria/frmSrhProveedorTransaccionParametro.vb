Public Class frmSrhProveedorTransaccionParametro

    Dim XdtParametros As BOSistema.Win.XDataSet.xDataTable

    Private Sub frmSteParametrosContablesProveedor_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub CargarParametros()
        Try
            ...
            Strsql = " Select * From vwSrhProveedorTransaccionParametro " & _
                     " "
            ...
            Me.grdParametro.Caption = " Listado de ... (" + Me.grdParametro.RowCount.ToString + " registros)"
    ...
    Private Sub FormatoParametro()
        Try
            ...
            Me.grdParametro.Splits(0).DisplayColumns("nSrhProveedorTransaccionParametroID").Visible = False
            'Me.grdParametro.Splits(0).DisplayColumns("sCodigoCuenta").Visible = False
            Me.grdParametro.Splits(0).DisplayColumns("nScnFuenteFinanciamientoID").Visible = False
            Me.grdParametro.Splits(0).DisplayColumns("nStbPersonaID").Visible = False
            Me.grdParametro.Splits(0).DisplayColumns("nStbTipoRenglonID").Visible = False
            'Me.grdParametro.Splits(0).DisplayColumns("nStbValorCatalogoID").Visible = False
            ...
            Me.grdParametro.Columns("Fuente").Caption = "Fuente de Fondos"
            'Me.grdParametro.Columns("sNombre1").Caption = "Persona"
            ...
            Me.grdParametro.Columns("Renglon").Caption = "Tipo Renglón"
    ...
    Private Sub LlamaAgregarParametro()
        Dim ObjFrmSclEditParametro As New frmSrhEditProveedorTransaccionParametro
        Try
            ...
            If ObjFrmSclEditParametro.IdParametro <> 0 Then 'No se produjo error.
                ...
                XdtParametros.SetCurrentByID("nSrhProveedorTransaccionParametroID", ObjFrmSclEditParametro.IdParametro)
            End If
    ...
    Private Sub LlamaModificarParametro()
        ...
        Try
            ...
            ObjFrmSclEditParametro.IdParametro = XdtParametros.ValueField("nSrhProveedorTransaccionParametroID")
    ...
    Private Sub LlamaEliminarParametro()
        ...
        Try
            ...
            If MsgBox("¿Está seguro de eliminar el registro seleccionado?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, NombreSistema) = MsgBoxResult.Yes Then
                XdtParametroEliminar.ExecuteSqlNotTable("Delete From SrhProveedorTransaccionParametro where nSrhProveedorTransaccionParametroID=" & XdtParametros.ValueField("nSrhProveedorTransaccionParametroID"))
                CargarParametros()
