...
Public Class frmScnParametroEstadosFinancieros
    ...
    Private Sub frmScnParametroEstadosFinancieros_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If Me.NomRep = 1 Then
                Me.Text = " Parámetros de Estados Financieros - Estado de Resultados"
            Else
                Me.Text = " Parámetros de Estados Financieros - Balance General"
            End If
            ...
            Select Case mNomRep
                Case EnumReportes.EstadoResultados
                    If chkConsolida.Checked = True Then
                        ...
                        ElseIf optCAnual.Checked = True Then
                            frmVisor.NombreReporte = "RepScnCN18c_Anual.rpt"
                            frmVisor.Text = "Estado de Resultados Consolidado - Anual"
                        ElseIf optCMensual.Checked = True Then
                            frmVisor.NombreReporte = "RepScnCN18C_Mensual.rpt"
                            frmVisor.Text = "Estado de Resultados Consolidado - Mensual"
                        Else
                            frmVisor.NombreReporte = "RepScnCN18c_Mensualizado.rpt"
                            frmVisor.Text = "Estado de Resultados Consolidado - Mensualizado"
                        End If
                ...
                Case EnumReportes.BalanceGeneral
                    If chkConsolida.Checked = True Then
                        ...
                        ElseIf optCAnual.Checked = True Then
                            frmVisor.NombreReporte = "RepScnCN19c_Anual.rpt"
                            frmVisor.Text = "Balance General Consolidado - Anual"
                        ElseIf optCMensual.Checked = True Then
                            frmVisor.NombreReporte = "RepScnCN19C_Mensual.rpt"
                            frmVisor.Text = "Balance General Consolidado - Mensual"
                        Else
                            frmVisor.NombreReporte = "RepScnCN19c_Mensualizado.rpt"
                            frmVisor.Text = "Balance General Consolidado - Mensualizado"
                        End If
                        frmScnObservacion = New frmScnObservacionesConsolidado
