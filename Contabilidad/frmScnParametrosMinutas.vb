        ...
        Try
            ...
            Select Case mNomRep
                ...
                Case EnumReportes.DetalleCierre
                    ...
                    If Me.RdPDIBATodas.Checked = True Then
                        frmVisor.Parametros("@TipoPrograma1") = "0"
                        frmVisor.Parametros("@TipoPrograma2") = "0"
                        frmVisor.Formulas("Parametro") = "'Filtro: (" & Me.RdPDIBATodas.Text & ")'"
                    ElseIf Me.RdPDIBA.Checked = True Then
                        frmVisor.Parametros("@TipoPrograma1") = "3"
                        frmVisor.Parametros("@TipoPrograma2") = "3"
                        frmVisor.Formulas("Parametro") = "'Filtro: (" & Me.RdPDIBA.Text & ")'"
                    Else
                        frmVisor.Parametros("@TipoPrograma1") = "1"
                        frmVisor.Parametros("@TipoPrograma2") = "2"
                        frmVisor.Formulas("Parametro") = "'Filtro: (" & Me.RdNoPDIBA.Text & ")'"
                    End If
